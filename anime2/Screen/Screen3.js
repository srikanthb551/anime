...
export default class Screen3 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      data: [
        {id:1, title: "Youtube", image:require("../assets/you.png"),color:"#f83f37"},
        {id:2, title: "Vimeo", image:require("../assets/tw.png"),color:"#01aced"} ,
        {id:4, title: "Metacafe", image:require("../assets/inst.jpeg"),color:"#d53c4f"} ,
        {id:8, title: "Dailymotion", image:require("../assets/gm.jpg"),color:"#dd4e40"} ,
        {id:9, title: "Veoh", image:require("../assets/gg.jpg"),color:"#dd4c3b"} ,
        {id:3, title: "Internet Archive", image:require("../assets/link1.png"),color:"#017bb6"} ,
        {id:5, title: "Crackle", image:require("../assets/snap.png"),color:"#ebe13a"} ,
        {id:6, title: "Twitch", image:require("../assets/pin.png"),color:"#b72c26"} ,
        {id:7, title: "TED Talks", image:require("../assets/ted1.jpg"),color:"#e63a33"},       
